...
make O=out ARCH=arm64 RMX2193_defconfig
...
function zupload()
{
git clone --depth=1 https://github.com/sarthakroy2002/AnyKernel3.git -b RMX2193 AnyKernel
cp out/arch/arm64/boot/Image.gz-dtb AnyKernel
cd AnyKernel
zip -r9 Test-OSS-KERNEL-RMX2193.zip *
curl -sL https://git.io/file-transfer | sh
./transfer wet Test-OSS-KERNEL-RMX2193.zip
}
