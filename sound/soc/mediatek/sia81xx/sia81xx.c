	...
	char* buf)
{
	...
	snprintf(tb, 1024, "sia81xx_cmd_show : owi pin : %d, chip id = 0x%02x \r\n"
		...
		vals[14], vals[15], vals[16], vals[17], vals[18], vals[19], vals[20], vals[21], vals[22],
		vals[23], vals[24], vals[25], vals[26], vals[27], vals[28], vals[29], vals[30], vals[31],
