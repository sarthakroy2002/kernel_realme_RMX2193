...
#define LS_FW_SIGN_FILP_PATH         "tp/206A1/ls_ili9882n_oppo_signed.bin"
#define TRULY_FW_SIGN_FILP_PATH      "tp/206A1/truly_ili9882n_oppo_signed.bin"
#define TXD_FW_SIGN_FILP_PATH      "tp/206AC/txd_ili9882n_oppo_signed.bin"
...
/*ritchie add for oppo*/
#define OPPO_DBG(level, fmt, arg...)						\
	do {									\
		if (level & ilits->oppo_debug_level)						\
