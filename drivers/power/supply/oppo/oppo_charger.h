...
#define NOTIFY_FLASHLIGHT_TERMINAL      21
...
#ifdef ODM_WT_EDIT
/*Sidong.Zhao@ODM_WT.BSP.CHG 2019/11/11,add charge parameter for V3.5 OPPO charge SPEC*/
...
/*Sidong.Zhao@ODM_WT.BSP.CHG 2019/11/27,AP thermal machine*/
	...
	int batt_temp_extend_t0;
	int batt_temp_extend_t0_minus_x;
	int batt_temp_extend_t1;
	int batt_temp_extend_t1_minus_x;
	int batt_temp_extend_t2;
	int batt_temp_extend_t2_minus_x;
	int batt_temp_extend_t3;
	int batt_temp_extend_t3_minus_x;
	int batt_temp_extend_t4;
	int batt_temp_extend_t4_minus_x;
	int batt_temp_extend_t5;
	int batt_temp_extend_t5_minus_x;
	int batt_temp_extend_t6;
	int batt_temp_extend_t6_minus_x;
	int batt_temp_extend_t7;
	int batt_temp_extend_t7_minus_x;
...
/* Sidong.Zhao@ODM_WT.BSP.CHG 2020/8/3, USB overtemp protection*/
        bool               dischg_flag;
#endif /*ODM_WT_EDIT*/
...
//Sidong.Zhao@ODM_WT.BSP.CHG,2020/07/31,add for usb overtemp protection
