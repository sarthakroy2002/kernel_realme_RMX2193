...
#elif defined(CONFIG_OPPO_CHARGER_MTK6763) || defined(CONFIG_CHARGER_SY6974)
#include <linux/module.h>
...
{
#ifdef CONFIG_OPPO_CHARGER_MTK
#if defined(CONFIG_OPPO_CHARGER_MTK6763) || defined(CONFIG_CHARGER_SY6974)
	int ret = 0;
...
#if defined (CONFIG_MTK_PMIC_CHIP_MT6353) || defined(CONFIG_OPPO_CHARGER_MTK6763) || defined(CONFIG_CHARGER_SY6974)
...
#else /*defined (CONFIG_MTK_PMIC_CHIP_MT6353) || defined(CONFIG_OPPO_CHARGER_MTK6763) || defined(CONFIG_CHARGER_SY6974)*/
static int sy6974_reset_charger(void)
{
	int rc = 0;
	struct chip_sy6974 *chip = charger_ic;
...
#endif /*defined (CONFIG_MTK_PMIC_CHIP_MT6353) || defined(CONFIG_OPPO_CHARGER_MTK6763) || defined(CONFIG_CHARGER_SY6974)*/
...
struct oppo_chg_operations  oppo_chg_sy6974_ops = {
...
static void do_sy6974_irq_delay_work(struct work_struct *data)
{
	...
	printk("[OPPO_CHG] do_sy6974_irq_delay_work disable vbus out flag=%d, val_reg[0x%x]\n", otg_overcurrent_flag, val_reg);
