...
static int bq2589x_enable_otg(struct bq2589x *bq)
{
	...
	if(g_oppo_chip->is_double_charger_support) {
		msleep(50);
		g_oppo_chip->sub_chg_ops->charger_suspend();
	}
...
//	void (*check_is_iindpm_mode) (void);
	...
	.oppo_chg_set_hz_mode = bq2589x_set_hz_mode,
};
