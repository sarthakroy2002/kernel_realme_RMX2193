...
static void HLT_S5K4H7_read_OTP(struct HLT_S5K4H7_otp_struct *S5K4H7_OTP)
{
	...
	if(val==0x01)
	{
		...
		S5K4H7_HLT_write_cmos_sensor(0x0A02,0x16);//page 0x16
		S5K4H7_HLT_write_cmos_sensor(0x3B41,0x01);
		S5K4H7_HLT_write_cmos_sensor(0x3B42,0x03);
		S5K4H7_HLT_write_cmos_sensor(0x3B40,0x01);
		S5K4H7_HLT_write_cmos_sensor(0x0A00,0x01);

		S5K4H7_OTP->MID = (S5K4H7_OTP->MID << 8) | (S5K4H7_HLT_read_cmos_sensor(0x0A28));
	} else {
		S5K4H7_HLT_write_cmos_sensor(0x0A02,0x17);//page 0x17
		S5K4H7_HLT_write_cmos_sensor(0x3B41,0x01);
		S5K4H7_HLT_write_cmos_sensor(0x3B42,0x03);
		S5K4H7_HLT_write_cmos_sensor(0x3B40,0x01);
		S5K4H7_HLT_write_cmos_sensor(0x0A00,0x01);
		...
		if(val==0x01){
			...
			S5K4H7_HLT_write_cmos_sensor(0x0A02,0x18);//page 0x18
			S5K4H7_HLT_write_cmos_sensor(0x3B41,0x01);
			S5K4H7_HLT_write_cmos_sensor(0x3B42,0x03);
			S5K4H7_HLT_write_cmos_sensor(0x3B40,0x01);
			S5K4H7_HLT_write_cmos_sensor(0x0A00,0x01);
...
int HLT_S5K4H7_OTP_CheckID(void)
{
