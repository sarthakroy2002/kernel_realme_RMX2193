...
#ifdef VENDOR_EDIT
/* Shipei.Chen@Cam.Drv, 20200608, otp porting for 206AC!*/
...
/* wenhui.chen@Cam.Drv, 20200615, sensor porting for pascalA/C*/
	if(pascal_project() == 4){
		imgsensor_i2c_init(&psensor_inst->i2c_cfg,
			imgsensor_custom_config_pascalA[psensor->inst.sensor_idx].i2c_dev);
...
struct match_hardwareinfo hardwareinfo_camera_name[] = {
	...
	{ SENSOR_DRVNAME_PASCALA_TRULY_MAIN_S5KGM1SP,   "pascala_truly_main_s5kgm1sp", " 0x08D2"},
	{ SENSOR_DRVNAME_PASCALA_TRULY2_MAIN_S5KGM1SP,   "pascala_truly2_main_s5kgm1sp", " 0x08D3"},
	{ SENSOR_DRVNAME_PASCALA_HLT_FRONT_S5K4H7,   "pascala_hlt_front_s5k4h7", " 0x487C"},
	{ SENSOR_DRVNAME_PASCALA_SHENGTAI_MACRO_OV02B10,   "pascala_shengtai_macro_ov02b10", " 0x0030"},
	{ SENSOR_DRVNAME_PASCALA_SHENGTAI_WIDE_OV8856,   "pascala_shengtai_wide_ov8856", " 0x885B"},
	{ SENSOR_DRVNAME_PASCALA_SUNNY_WIDE_OV8856,   "pascala_sunny_wide_ov8856", " 0x885C"},
	{ SENSOR_DRVNAME_PASCALC_SHENGTAI_MONO_OV02B1B,   "pascalc_shengtai_mono_ov02b1b", " 0x002C"},
	{ SENSOR_DRVNAME_PASCALC_SHENGTAI_MAIN_OV12A10,   "pascalc_shengtai_main_ov12a10", " 0x1243"},
	{ SENSOR_DRVNAME_PASCALI_QTECH_MAIN_OV13B10,   "pascali_qtech_main_ov13b10", " 0x560D45"},
	{ SENSOR_DRVNAME_PASCALI_HLT_FRONT_S5K4H7,   "pascali_hlt_front_s5k4h7", " 0x487D"},
	{ SENSOR_DRVNAME_PASCALI_HLT_DEPTH_GC02M1B,   "pascali_hlt_depth_gc02m1b", " 0x02E5"},
	{"NULL", "UNKNOWN", "0"},
};
#endif /* ODM_WT_EDIT */
