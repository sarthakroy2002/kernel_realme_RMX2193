...
#endif
#endif /* ODM_WT_EDIT */
/* Yang.Zhang@Camera.Driver, 2020/06/15, add for [otp bringup] */
#if defined(PASCALC_SHENGTAI_MAIN_OV12A10)
	{PASCALC_SHENGTAI_MAIN_OV12A10_SENSOR_ID,
	SENSOR_DRVNAME_PASCALC_SHENGTAI_MAIN_OV12A10,
	OV12A10_SHENGTAI_MIPI_RAW_SensorInit},
#endif
#ifdef ODM_WT_EDIT
...
#endif
/* wenhui.chen@Cam.Drv, 20200615, sensor porting for pascalC*/
#if defined(PASCALC_SHENGTAI_MONO_OV02B1B)
	{PASCALC_SHENGTAI_MONO_OV02B1B_SENSOR_ID,
	SENSOR_DRVNAME_PASCALC_SHENGTAI_MONO_OV02B1B,
	PASCALC_SHENGTAI_MONO_OV02B1B_MIPI_RAW_SensorInit},
#endif
#if defined(PASCALA_SHENGTAI_MACRO_OV02B10)
	{PASCALA_SHENGTAI_MACRO_OV02B10_SENSOR_ID,
	...
	{PASCALA_HLT_FRONT_S5K4H7_SENSOR_ID,
...
/* wenhui.chen@Cam.Drv, 20201012, sensor porting for pascali ov13b10 gc02m1b*/
	...
	{PASCALI_QTECH_MAIN_OV13B10_SENSOR_ID,SENSOR_DRVNAME_PASCALI_QTECH_MAIN_OV13B10,
		OV13B10_QTECH_MIPI_RAW_SensorInit},
#endif
#if defined(PASCALI_HLT_DEPTH_GC02M1B)
	{PASCALI_HLT_DEPTH_GC02M1B_MIPI_SENSOR_ID,SENSOR_DRVNAME_PASCALI_HLT_DEPTH_GC02M1B,
