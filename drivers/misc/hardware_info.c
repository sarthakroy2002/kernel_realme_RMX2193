...
//Haibo.Dong@ODM_WT.Kernel.Boardid, 2020/12/02, add pascal-I pcb version match
	}else if((get_Operator_Version() == OPERATOR_206I_ASIA_SIMPLE) ||
		(get_Operator_Version() == OPERATOR_206I_All_BAND)){
		switch(PCB_Version){
			case 0x00:
			strncpy(hardware_id,"P0",HARDWARE_MAX_ITEM_LONGTH);
			break;
			case 0x01:
